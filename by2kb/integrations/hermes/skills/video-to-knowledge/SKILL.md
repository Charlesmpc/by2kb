...
description: Use by2kb to turn a Bilibili URL into a transcript, a short abstract, and long-form study notes. Use when a user sends or mentions a Bilibili or b23.tv video URL.
---

# Video to knowledge

The installed Hermes plugin handles a bare Bilibili URL automatically. It runs
the deterministic transcription stage first, then uses the Hermes host model for
...
3. Run `by2kb ingest <URL> --enricher external_agent --json`.
