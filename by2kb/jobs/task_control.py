...
_STAGE = {
    ...
    JobStatus.RESOLVING_SOURCE: "resolving_source",
    JobStatus.FETCHING_METADATA: "fetching_metadata",
    JobStatus.BROWSER_CONNECTING: "browser_connecting",
    JobStatus.BROWSER_LOADING: "browser_loading",
    JobStatus.WAITING_MEDIA: "waiting_media",
    JobStatus.DOWNLOADING_MEDIA: "downloading_media",
    JobStatus.VALIDATING_MEDIA: "validating_media",
...
_PROGRESS = {
    ...
    JobStatus.RESOLVING_SOURCE: 0.1,
    JobStatus.FETCHING_METADATA: 0.15,
    JobStatus.BROWSER_CONNECTING: 0.2,
    JobStatus.BROWSER_LOADING: 0.22,
    JobStatus.WAITING_MEDIA: 0.24,
    JobStatus.DOWNLOADING_MEDIA: 0.25,
    JobStatus.VALIDATING_MEDIA: 0.4,
